...
bot.on("message", async message => {
    ...
    if(cmd === `${prefix}tj`){
        ...
        .setThumbnail('https://e7.pngegg.com/pngimages/749/913/png-clipart-assassin-s-creed-iii-assassin-s-creed-syndicate-assassin-s-creed-iv-black-flag-assassins-creed-miscellaneous-triangle.png')
