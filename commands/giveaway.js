    ...
    let giveawayWinners = args[2];
     ...
     if (!giveawayPrize) return message.channel.send('Ok then, I\'ll give away nothing');
        ...
        bot.giveawaysManager.start(channel, {
            ...
            hostedBy: bot.botsettings.hostedBy ? message.author : null,

            messages: {
                giveaway: (bot.botsettings.everyoneMention ? "@everyone\n\n" : "") + "GIVEAWAY",
                giveawayEned: (bot.botsettings.everyoneMention ? "@everyone\n\n" : "") + "GIVEAWAY ENDED",
